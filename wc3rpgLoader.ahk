...
Gui, Add, Checkbox, y+30 gGetSetCheckBoxValue vDisableAllNativeFunctions
...
initial()
{
    ...
    if(clientVersion < 4.7) ; 4.7 remove useless
    {
        IniDelete, %iniFile%, Settings, FistUlt
        IniDelete, %iniFile%, Settings, DropPowders
    }
